  ...
  <div class="containerNavbar" colour="red">
    ...
    <div class="collapse navbar-collapse">
      ...
      <li><a href="../">Početna stranica</a></li>
        <li class="active"><a href="#">Klijenti</a></li>
  ...
  <div class="container">
   ...
   <div class="panel panel-default">
    <div class="panel-heading">
     <div class="row">
      <div class="col-md-6">
       <h3 class="panel-title">Podaci o klijentima</h3>
      </div>
...
$(document).ready(function(){
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    new Dialogify('forms/edit_data_form.php', options)
     .title('Izmeni podatke o klijentu')
     .buttons([
      {
       text:'Otkaži',
       click:function(e){
 ...
 $(document).on('click', '.delete', function(){
  var id = $(this).attr('id');
  Dialogify.confirm("<h3 class='text-danger'><b>Da li ste sigurni da želite da uklonite klijeta?</b></h3>", {
   ok:function(){
    $.ajax({
     ...
     success:function(data)
     {
      Dialogify.alert('<h3 class="text-success text-center"><b>Klijent uspešno uklonjen</b></h3>');
      dataTable.ajax.reload();
     }
    })
   },
